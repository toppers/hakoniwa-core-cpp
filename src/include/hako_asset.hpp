...
namespace hako {
    ...
    public:
        ...
        virtual bool create_pdu_lchannel(const std::string& asset_name, HakoPduChannelIdType channel_id, size_t pdu_size) = 0;
        virtual HakoPduChannelIdType get_pdu_channel(const std::string& asset_name, HakoPduChannelIdType channel_id) = 0;
        virtual bool is_pdu_dirty(const std::string& asset_name, HakoPduChannelIdType channel_id) = 0;
